...
#    include <io.h>
#    include <process.h>
#    if defined(BCPP) || defined(WATCOM) || defined(__TOS_OS2__) || defined(OS2OW)
#        include <direct.h>
#    endif
#    if defined(BCPP)
#        include <dir.h>
...
#    if !defined(__EMX__) || !defined(OS2OW)
...
#if (!defined(__IBMC__) && !defined(__IBMCPP__)) || !defined(OS2) || defined(OS2OW)
#    define _LNK_CONV
#endif
